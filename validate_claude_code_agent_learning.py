...
def run_test_suite(test_class, description):
    ...
    try:
        ...
        if result.returncode == 0:
            ...
            print(f"   =Ê Tests passed: {passed_count}")
        else:
...
def run_coordination_hub_validation():
    ...
    print(f"\n>ê Running Coordination Hub Learning Validation...")
    print("=" * 60)
    ...
    try:
        ...
        print(f"ñ  Coordination Hub Learning Validation - TIMEOUT (>60s)")
        return False
    except Exception as e:
...
def main():
    ...
    print(f"\n=Ê Overall Results: {passed_count}/{total_count} test suites passed")
    print(f"ñ  Total validation time: {total_time:.1f}s")
