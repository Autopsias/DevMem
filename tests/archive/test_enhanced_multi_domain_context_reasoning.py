...
class TestSemanticAnalyzer:
    ...
    def test_domain_pattern_recognition(self, analyzer):
        ...
        test_cases = [
            (
                "Docker container testing with async patterns",
                ["testing", "infrastructure"],
            ),
            (
                "Security vulnerability requires immediate authentication fix",
                ["security"],
            ),
            ("Performance optimization for bottleneck analysis", ["performance"]),
            (
                "Infrastructure deployment with security compliance",
        ...
        for query, expected_domains in test_cases:
            ...
            for expected_domain in expected_domains:
                assert (
                    expected_domain in detected_domains
    ...
    def test_relationship_pattern_detection(self, analyzer):
        ...
        for query, expected_relationship in test_cases:
            analysis = analyzer.analyze_semantic_patterns(query)
            relationship_types = [
                rel["type"] for rel in analysis["relationship_indicators"]
            ]

            assert (
                expected_relationship in relationship_types
    ...
    def test_semantic_complexity_calculation(self, analyzer):
        ...
        test_cases = [
            ...
            (
                "Docker container security testing coordination",
                0.4,
                0.8,
            ),  # Multi-domain, medium complexity
            (
...
class TestCrossDomainRelationshipMapper:
    ...
    def test_relationship_registration(self, mapper):
        ...
        ), f"Expected reverse strength 0.8, got {reverse_strength}"
    ...
    def test_domain_path_finding(self, mapper):
        ...
        relationships = [
            ...
            DomainRelationship(
                "infrastructure", "security", DomainRelationshipType.SEQUENTIAL, 0.6
            ),
        ]
        ...
        assert path == [
            ...
            "infrastructure",
            "security",
        ], f"Expected indirect path, got {path}"
    ...
    def test_related_domains_discovery(self, mapper):
        ...
        relationships = [
            ...
            DomainRelationship(
                "testing", "performance", DomainRelationshipType.PARALLEL, 0.4
            ),
        ]
        ...
        assert related[0] == (
            "infrastructure",
            0.8,
        ), f"Expected ('infrastructure', 0.8), got {related[0]}"
        assert related[1] == (
            "security",
            0.6,
        ), f"Expected ('security', 0.6), got {related[1]}"
    ...
    def test_relationship_strength_updates(self, mapper):
        ...
        ), f"Expected strength decrease, got {final_strength}"
...
class TestContextPreservationManager:
    ...
    def test_selective_transfer_strategy(self, manager, sample_context_elements):
        ...
        assert (
            len(preserved) >= 2
        ), f"Expected at least 2 preserved elements, got {len(preserved)}"
        assert len(preserved) < len(
            sample_context_elements
        ...
        ), f"Expected at least 2 critical elements, got {critical_preserved}"
    ...
    def test_context_preservation_metrics(self, manager, sample_context_elements):
        ...
        assert (
            0 <= metrics.critical_elements_preserved <= metrics.critical_elements_total
        )
...
class TestDomainSpecificOptimizer:
    ...
    def test_domain_optimization_strategies(self, optimizer):
        ...
        test_cases = [
            ...
            (
                "infrastructure",
                "Docker container orchestration scaling issues",
                ["infrastructure-engineer"],
            ),
            (
                "security",
                "authentication vulnerability analysis needed",
                ["security-auditor"],
            ),
            (
                "performance",
                "latency optimization for API endpoints",
        ...
        for domain, query, expected_agents in test_cases:
            ...
            assert result["coordination_strategy"] in [
                "sequential",
                "parallel",
                "hierarchical",
            ]
    ...
    def test_coordination_request_analysis(self, optimizer):
        ...
        analysis = optimizer._analyze_coordination_request(
            high_priority_query, domain_config
        )

        assert (
            len(analysis["priority_keyword_matches"]) >= 2
    ...
    def test_performance_baseline_management(self, optimizer):
        ...
        new_metrics = {"avg_response_time_ms": 1200.0, "success_rate": 0.92}
        ...
        assert (
            updated_baseline["avg_response_time_ms"] != baseline["avg_response_time_ms"]
        )
...
class TestEnhancedMultiDomainContextReasoner:
    ...
    def test_simple_single_domain_analysis(self, reasoner):
        ...
        assert analysis["pattern_complexity"] in [
            PatternComplexity.SIMPLE,
            PatternComplexity.MODERATE,
        ]
        assert analysis["coordination_strategy"]["approach"] in [
            "direct_agent",
    ...
    def test_complex_multi_domain_analysis(self, reasoner):
        ...
        assert analysis["pattern_complexity"] in [
            PatternComplexity.COMPLEX,
            PatternComplexity.CRITICAL,
        ]
        assert analysis["coordination_strategy"]["approach"] in [
            "parallel_coordination",
            "hierarchical_meta_coordination",
        ]
    ...
    def test_coordination_strategy_generation(self, reasoner):
        ...
        test_cases = [
            ...
            (
                ...
                ["sequential_coordination", "parallel_coordination"],
            ),
            (
                "Multi-domain crisis response",
                ["hierarchical_meta_coordination", "parallel_coordination"],
            ),
        ]
        ...
        for query, expected_approaches in test_cases:
            ...
            assert (
                strategy["approach"] in expected_approaches
    ...
    def test_context_preservation_strategy_selection(self, reasoner):
        ...
        for complexity, domain_count, expected_strategy in test_cases:
            strategy = reasoner._select_context_preservation_strategy(
                complexity, domain_count
            )
            assert (
                strategy.value == expected_strategy
...
class TestPerformanceRequirements:
    ...
    def test_analysis_performance_targets(self, reasoner):
        ...
        test_cases = [
            ...
            (
                "Comprehensive multi-domain analysis with parallel coordination",
                "complex",
            ),
        ]
    ...
    def test_context_preservation_performance(self, reasoner):
        ...
        sample_contexts = [
            ...
            [
                ContextElement(
                    f"elem_{i}", f"content_{i}", "testing", 0.5, datetime.now()
                )
                for i in range(5)
            ],
...
class TestIntegrationScenarios:
    ...
    def test_security_performance_conflict_resolution(self, reasoner):
        ...
        relationship_indicators = [
            rel["type"] for rel in semantic_analysis["relationship_indicators"]
        ]
        ...
        assert (
            analysis["reasoning_confidence"] > 0.5
        )  # Should be confident about conflict detection
