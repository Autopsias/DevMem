...
try:
    from learning_enhanced_agent_selector import LearningEnhancedAgentSelector, AgentSelectionResult
except ImportError as e:
    pytest.skip(f"Could not import learning-enhanced agent selector: {e}", allow_module_level=True)
...
"""
    ...
    def learning_selector(self, temp_system_setup):
        ...
        if selector.learning_engine:
            ...
            selector.learning_engine.agent_profiles = selector.learning_engine.parse_agent_descriptions()
    ...
    def test_integration_with_existing_coordinator(self, learning_selector):
        ...
        assert result.confidence_score > 0.3  # Reasonable confidence even for complex queries
